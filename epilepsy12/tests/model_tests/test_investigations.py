...
- [x] Investigations.eeg_request_date cannot be before Registration.first_paediatric_assessment_date
...
- [x] Investigations.mri_brain_requested_date cannot be before Registration.first_paediatric_assessment_date
...
def test_validation_request_date_cant_be_before_registration(
    ...
    """Tests:
    - Investigations.eeg_request_date cannot be before Registration.first_paediatric_assessment_date
    - Investigations.mri_brain_requested_date cannot be before Registration.first_paediatric_assessment_date
    """

    # assign request date to 10 days before registration
    first_paediatric_assessment_date = date(2023, 1, 1)
    request_date = first_paediatric_assessment_date - relativedelta(days=10)
